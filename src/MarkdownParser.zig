...
pub fn get_block_type(block: []const u8) !BlockType {
...
pub const MarkdownParser = struct {
    ...
    pub fn markdown_to_blocks(self: *const MarkdownParser, allocator: std.mem.Allocator) ![][]const u8 {
...
test "one 1 list" {
    ...
    const t = try get_block_type(str);
